...
public class SlaveHandler extends SimpleChannelInboundHandler<Request> {
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) {
        logger.error("slave caught exception", cause);
        ctx.close();
    }
}
